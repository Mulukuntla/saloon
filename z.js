function handleFormSubmit(event) {
  ...
  function gett(date){
    ...
    const userItemHtmls = `
      <form id="showAtt">
      Siva :  <a> "${Siva2}" "${Siva1}"</a><br>
      Rajesh :  <a> "${Rajesh2}" "${Rajesh1}" </a><br> 
      Ashok :  <a> "${Ashok2}" "${Ashok1}" </a><br> 
      Sai :  <a> "${Sai2}" "${Sai1}" </a><br> 
      Haritha :  <a> "${Haritha2}" "${Haritha1}" </a><br> 
      Ram :  <a> "${Ram2}" "${Ram1}" </a><br> 
      Krishna :  <a> "${Krishna2}" "${Krishna1}" </a><br> 
      Anu :  <a> "${Anu2}" "${Anu1}" </a><br> 
      Ammu :  <a> "${Ammu2}" "${Ammu1}" </a><br> 
      Adi :  <a> "${Adi2}" "${Adi1}" </a><br>  
      </form>
...
function showNames(event){
  ...
  userItemHtmls = `
      ...
      Siva :<input type="radio" name="Siva" value="present">Present <input type="radio" name="Siva" value="absent">Absent<br>
      Rajesh :<input type="radio" name="Rajesh" value="present">Present <input type="radio" name="Rajesh" value="absent">Absent<br> 
      Ashok :<input type="radio" name="Ashok" value="present">Present <input type="radio" name="Ashok" value="absent">Absent<br> 
      Sai :<input type="radio" name="Sai" value="present">Present <input type="radio" name="Sai" value="absent">Absent<br> 
      Haritha :<input type="radio" name="Haritha" value="present">Present <input type="radio" name="Haritha" value="absent">Absent<br> 
      Ram :<input type="radio" name="Ram" value="present">Present <input type="radio" name="Ram" value="absent">Absent<br> 
      Krishna :<input type="radio" name="Krishna" value="present">Present <input type="radio" name="Krishna" value="absent">Absent<br> 
      Anu :<input type="radio" name="Anu" value="present">Present <input type="radio" name="Anu" value="absent">Absent<br> 
      Ammu :<input type="radio" name="Ammu" value="present">Present <input type="radio" name="Ammu" value="absent">Absent<br> 
      Adi :<input type="radio" name="Adi" value="present">Present <input type="radio" name="Adi" value="absent">Absent<br>  
...
function handleForm(){
  ...
  .then(response =>{
    ...
    const userItemHtmls = `
      <form id="showTotall">
      Siva :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp <span>"${Siva1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Siva2}"%</span><br>
      Rajesh :&nbsp;&nbsp;&nbsp;&nbsp&nbsp  <span>  "${Rajesh1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"${Rajesh2}"% </span><br> 
      Ashok :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;  <a>  "${Ashok1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Ashok2}"% </a><br> 
      Sai :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp  <a>  "${Sai1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Sai2}"% </a><br> 
      Haritha :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp  <a>  "${Haritha1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Haritha2}"% </a><br> 
      Ram :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp  <a>  "${Ram1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Ram2}"%  </a><br> 
      Krishna :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp  <a>  "${Krishna1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Krishna2}"% </a><br> 
      Anu :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp  <a>  "${Anu1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Anu2}"%  </a><br> 
      Ammu :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp  <a>  "${Ammu1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Ammu2}"%  </a><br> 
      Adi :&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp  <a>  "${Adi1}"/"${total}"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"${Adi2}"% </a><br>  
      </form>
